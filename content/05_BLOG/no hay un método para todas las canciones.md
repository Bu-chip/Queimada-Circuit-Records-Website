...
- Llevar ideas musicales que uno tiene a la vida
- Generar nuevas ideas por las ganas de hacer música
- Componer (suena más exacto, pero también más formal)
...
1. **IMAGEN → TEXTURA**  
   Coger una imagen y jugar con sus curvas, sus colores. Una que pueda funcionar de textura. Convertirla en un visual para acompañar un tema.

2. **LUGAR IMAGINADO → IA → RUNWAY**  
   Pedir a alguien que imagine un sitio. Representarlo con cualquier IA generativa. Luego animar ese espacio con Runway o similar.

3. **CUALQUIER COSA → MIDI**  
   Pasar el ruido del autobús, tu voz, un ritmo que hagas con la boca a MIDI con Ableton. El motor es un drone. Las frenadas son percusión.

4. **INTERCAMBIAR ROLES**  
   Pasar las baterías a melodías o viceversa. El bajo se convierte en hi-hat. Los acordes se convierten en kick. Intercambiar midis.

5. **SEGUIR UN TUTORIAL Y TIRAR**  
   Busca un tutorial de TouchDesigner, Max/MSP, Processing, lo que sea. Sigue los tres primeros pasos. Luego rompe todo y haz lo contrario.

6. **COPIAR ESTRUCTURA**  
   Coger una canción que te guste. Copiar su estructura, escala y acordes principales. Modificar el resto: timbres, ritmo, atmósfera.

7. **CANCIÓN SOLO CON ECOS**  
   Hacer una canción solo con ecos de la misma canción. Un delay larguísimo. Reverb sin fin. Resampling infinito.

8. **RUIDOS IRRECONOCIBLES**  
   Hacer una canción solo con ruidos irreconocibles. Samples destruidos. Field recordings hasta que no sepas qué eran.

9. **METER PLUGINS HASTA QUE PETE**  
   Carga todos los plugins posibles en una pista hasta que crashee el DAW. El overload es parte del proceso.

10. **DOS NOTAS Y NADA MÁS**  
    Pintar dos notas donde sea. Construir todo a partir de ahí. Sin más. La limitación como motor.
...
Si quieres empezar gratis, aquí:

[bandlab.com](https://www.bandlab.com)
